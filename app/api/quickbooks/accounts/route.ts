...
export async function GET() {
  ...
  const query = 'SELECT * FROM Account WHERE AccountType IN (\'Bank\', \'Cash\', \'Accounts Receivable\', \'Accounts Payable\')';
  ...
  return NextResponse.json(data.QueryResponse?.Account || []);
}